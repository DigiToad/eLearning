...
<div class="min-h-screen  text-white">
  ...
  >
    ...
    <div class="relative max-w-7xl mx-auto px-6 py-16">
      <p
        class="text-base font-semibold tracking-widest text-primary-400 uppercase mb-3"
      >
        Your Learning Hub
      </p>
      <h1 class="text-5xl font-black tracking-tight mb-4">
        Explore <span
          class="text- bg-clip-text bg-gradient-to-r from-primary-400 to-orange-400"
          >Courses</span
        >
      </h1>
      ...
      <!-- <div class="mt-8 relative w-full max-w-md">
        ...
        <input
          ...
          class="w-full pl-12 pr-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent backdrop-blur-sm transition"
        />
      </div> -->
    </div>
  </div>
  ...
  >
    {#each courses as course (course._id ?? course.id)}
      <div
        class="group relative bg-[#1a1a2a] border border-white/10 shadow-primary-900 rounded-2xl overflow-hidden flex flex-col hover:border-primary-500 hover:shadow-xl hover:shadow-primary-900 transition-all duration-300 cursor-pointer"
      ...
      >
        ...
        <div class="relative overflow-hidden">
          ...
          >
            <div
              class="w-14 h-14 rounded-full bg-primary-600/90 backdrop-blur-sm flex items-center justify-center shadow-xl"
            >
              <svg
        ...
        <div class="p-5 flex flex-col flex-1">
          <!-- <span class="text-xs font-semibold text-primary-400 uppercase tracking-wider mb-2">{course.category}</span> -->

          <h2
            class="font-bold text-white text-base leading-snug line-clamp-2 group-hover:text-primary-300 transition-colors"
          >
            {course.title}
          </h2>
          ...
          <div class="flex items-center gap-2 mt-4">
            <img
              ...
              class="w-7 h-7 rounded-full bg-primary-800"
            />
          ...
          <button
            ...
            class="mt-5 w-full py-2.5 rounded-xl bg-gradient-to-r from-primary-600 to-primary-500 text-white text-sm font-bold hover:from-primary-500 hover:to-primary-400 transition-all duration-200 shadow-lg shadow-primary-900/30 flex items-center justify-center gap-2"
          >
